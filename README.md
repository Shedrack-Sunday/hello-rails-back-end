...
Follow this [Link](https://github.com/Shedrack-Sunday/hello-react-front-end) for the frontend repo
...
Feel free to check the [issues page](https://github.com/Shedrack-Sunday/hello-react-front-end/issues).
